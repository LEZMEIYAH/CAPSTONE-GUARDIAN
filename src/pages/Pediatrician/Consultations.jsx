...
const Consultations = () => {
  ...
  const getFilteredAndSortedConsultations = () => {
    ...
    if (sortOption === 'date') {
      ...
      filtered = filtered.sort((a, b) => a.patient_name.localeCompare(b.patient_name));
    }
  ...
  return (
    <main className="flex-1 bg-green-100 p-10 h-screen font-sans">
              ...
              {filteredConsultations.map((consultation) => {
                ...
                return (
                  <tr key={consultation.consultation_id} className="border-b hover:bg-green-50">
                    ...
                    <td className="py-2 px-4">{consultation.guardian_name}</td>
